	    	...
	    	buttons: [
	    		{
					...
					handler:function(){
						...
						if(!validate){
							...
							$.ajax({
								type: "post",
								url: "DeptServlet?method=EditDept",
    	...
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>部门经理:</td>
	    			<td>
	    				<input id="leader" name="leader" style="width: 200px; height: 30px;" class="easyui-textbox" type="text"   data-options="required:true, missingMessage:'不能为空'">
	    			</td>
	    		</tr>
	    	</table>
	    </form>
    	...
    	<input type="hidden" id="edit-id" name="id">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>部门经理:</td>
	    			<td>
	    				<input id="edit_leader" name="leader" style="width: 200px; height: 60px;" class="easyui-textbox" type="text" name="name"  data-options="required:true, missingMessage:'不能为空'">
	    			</td>
	    		</tr>
	    	</table>
	    </form>
