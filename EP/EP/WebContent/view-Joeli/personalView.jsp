	    	...
	    	buttons: [
	  	    		{
	  					...
	  					handler:function(){
	  						...
	  						if(!validate){
	  							...
	  							$.ajax({
	  								type: "post",
	  								url: "PersonalServlet?method=EditPasswod&t="+new Date().getTime(),
	    	...
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			...
	    			<td>
	    				...
	    				<input id="new_password" name="newpassword" style="width: 200px; height: 30px;" class="easyui-textbox" type="password" validType="password" name="password" data-options="required:true, missingMessage:'请输入新密码'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>新密码:</td>
