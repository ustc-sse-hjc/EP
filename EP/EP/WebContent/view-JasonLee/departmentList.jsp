...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"SystemServletDepartment?method=toClazzListView&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        ...
 		        {field:'info',title:'部门介绍',width:100, 
 		        },
	 		]], 
	        toolbar: "#toolbar"
	    }); 
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectRow == null){
            	...
            	$.messager.confirm("消息提醒", "将删除部门信息（如果部门下存在员工或领导则不能删除），确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="margin-top: 3px;">部门名称：<input id="clazzName" class="easyui-textbox" name="clazzName" />
